...
typedef struct {
	uchar mac_type:4;// 0: plc, 1:2.4G
	uchar route_type:4; // 0: gateway send:device found package, 1: device ack the found  package, 2:the beatheart between the next hop and the device
